    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                ...
                <main>
                <div class="card-header text-center" style="background-color: blue;color:white"> Liste des Clients </div>
				...
				<table class="table table-bordered table-striped">
                      ...
                      <i:forEach items="${ListeClient}" var="c">
                          <tr>
                              <td><i:out value="${c.id}"/></td>
                              <td><i:out value="${c.nom}"/></td>
                              <td><i:out value="${c.village.nom}"/></td>
                              <td><i:out value="${c.adresse}"/></td>
                              <td><i:out value="${c.telephone}"/></td>
                          </tr>
                      </i:forEach>
                  </table>
				</div>
