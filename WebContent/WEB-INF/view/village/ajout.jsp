    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
        	...
        	<div id="layoutSidenav_content">
                <main>
                <div class="card-header text-center" style="background-color: blue;color:white"> Formulaire des Villages </div>
       				<form class="container-fluid" action="Village" method="POST">
	                    <div class="form-group">
	                        <label class="control-label" for="nom"> Nom du Village</label>
